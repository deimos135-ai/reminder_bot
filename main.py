...
HELLO_TEXT = (
    ...
    "📌 Щопонеділка о 10:00 нагадую скинути плани / фокус на тиждень.\n"
    "📊 Щоп’ятниці о 16:00 нагадую скинути, що зробили за тиждень.\n\n"
    "Доступні команди:\n"
    "/hello — коротко про мене\n"
    "/weekly — показати нагадування про фокус на тиждень\n"
    "/day — показати нагадування про результат тижня\n\n"
...
async def on_startup(app):
    ...
    await bot.set_my_commands([
        ...
        BotCommand(command="day", description="Нагадування про результат тижня"),
    ])
